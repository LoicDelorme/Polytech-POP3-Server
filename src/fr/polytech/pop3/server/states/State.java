...
public abstract class State {
	...
	{
		COMMANDS.put(APOP.APOP_COMMAND_NAME, new APOP());
		COMMANDS.put(DELE.DELE_COMMAND_NAME, new DELE());
		COMMANDS.put(LIST.LIST_COMMAND_NAME, new LIST());
		COMMANDS.put(NOOP.NOOP_COMMAND_NAME, new NOOP());
		COMMANDS.put(PASS.PASS_COMMAND_NAME, new PASS());
		COMMANDS.put(QUIT.QUIT_COMMAND_NAME, new QUIT());
		COMMANDS.put(RETR.RETR_COMMAND_NAME, new RETR());
		COMMANDS.put(RSET.RSET_COMMAND_NAME, new RSET());
		COMMANDS.put(STAT.STAT_COMMAND_NAME, new STAT());
		COMMANDS.put(TOP.TOP_COMMAND_NAME, new TOP());
		COMMANDS.put(UIDL.UIDL_COMMAND_NAME, new UIDL());
		COMMANDS.put(USER.USER_COMMAND_NAME, new USER());
	}
